...
function sidebarColor(a) {
  ...
  var sidebar = document.querySelector('.cTheme');
...
function customNavbarFixed(el) {
  ...
  const navbar = document.getElementById('navbarBlur');
  const navbarCheck = document.getElementById('navbarFixed');

  if (el) {
    navbar.classList.add(...classes);
    navbar.setAttribute('navbar-scroll', 'true');
    navbarBlurOnScroll('navbarBlur');
    navbarCheck.setAttribute('checked', 'true');
  } else {
    navbar.classList.remove(...classes);
    navbar.setAttribute('navbar-scroll', 'false');
    navbarBlurOnScroll('navbarBlur');
    navbarCheck.removeAttribute('checked');
  }
}
...
const ofCanvas = document.getElementById('cOffcanvas');
...
if (ofCanvas) {
  ofCanvas.addEventListener('click', toggleSidenav);
}
...
function toggleSidenav() {
  if (body.classList.contains(className)) {
    ...
    ofCanvas.classList.remove('show');
  } else {
    body.classList.add(className);
    sidenav.classList.add('bg-white');
    sidenav.classList.remove('bg-transparent');
    iconSidenav.classList.remove('d-none');
    ofCanvas.classList.add('show');
  }
}
